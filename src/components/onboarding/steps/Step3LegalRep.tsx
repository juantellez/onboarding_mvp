...
import { Step3FormData } from "@/schemas/onboarding"

export function Step3LegalRep() {
  const { register, formState: { errors } } = useFormContext<Step3FormData>()

  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Información del Apoderado Legal</CardTitle>
        </CardHeader>
      ...
      <Card>
          <CardHeader>
              <CardTitle>Domicilio del Apoderado</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-4 md:grid-cols-2">
